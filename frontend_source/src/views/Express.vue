...
@keyframes loading { to { background-position: -220% 0; } }@media (max-width:340px) { .express-tabs button { font-size: 10px; } }@media (prefers-reduced-motion:reduce) { .is-loading { animation: none; } }
</style>
