...
const transactionForm = ref({ type: 'expense', amount: '', category: '餐饮', accountId: '', toAccountId: '', date: todayString(), note: '', currency: 'CNY', requestId: makeRequestId('wallet-transaction') })
