...
export default {
  ...
  setup() {
    ...
    const bodyPoints = {
      shoulder: { x: 423, y: 312, lx: 380, ly: 312, tx: 355, ty: 312, label: '肩宽' },
      chestUpper: { x: 542, y: 374, lx: 590, ly: 374, tx: 595, ty: 374, label: '上胸围' },
      chestLower: { x: 542, y: 437, lx: 590, ly: 437, tx: 595, ty: 437, label: '下胸围' },
      waist: { x: 542, y: 531, lx: 590, ly: 531, tx: 595, ty: 531, label: '腰围' },
      hip: { x: 542, y: 625, lx: 590, ly: 625, tx: 595, ty: 625, label: '臀围' },
      arm: { x: 370, y: 468, lx: 330, ly: 468, tx: 305, ty: 468, label: '臂围' },
      thigh: { x: 459, y: 665, lx: 410, ly: 665, tx: 355, ty: 665, label: '大腿围' },
      calf: { x: 459, y: 687, lx: 410, ly: 687, tx: 355, ty: 687, label: '小腿围' }
    }
