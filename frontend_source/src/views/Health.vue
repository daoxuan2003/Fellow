      ...
      <div class="body-map-section">
        <div class="body-map-card">
          ...
          <div class="body-map-wrapper">
            <svg class="body-svg" viewBox="300 0 450 750" preserveAspectRatio="xMidYMid meet">
...
export default {
  ...
  setup() {
    ...
    const bodyPoints = {
      shoulder: { x: 420, y: 290, lx: 380, ly: 290, tx: 355, ty: 290, label: '肩宽' },
      chestUpper: { x: 630, y: 350, lx: 665, ly: 350, tx: 670, ty: 350, label: '上胸围' },
      chestLower: { x: 630, y: 410, lx: 665, ly: 410, tx: 670, ty: 410, label: '下胸围' },
      waist: { x: 620, y: 480, lx: 655, ly: 480, tx: 660, ty: 480, label: '腰围' },
      hip: { x: 610, y: 540, lx: 645, ly: 540, tx: 650, ty: 540, label: '臀围' },
      arm: { x: 370, y: 360, lx: 330, ly: 360, tx: 305, ty: 360, label: '臂围' },
      thigh: { x: 400, y: 590, lx: 360, ly: 590, tx: 340, ty: 590, label: '大腿围' },
      calf: { x: 400, y: 670, lx: 360, ly: 670, tx: 340, ty: 670, label: '小腿围' }
    }
